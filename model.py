...
def model_original_size(input_shape=(112, 112, 1, 3), nb_classes=40, weight_decay = 0.005):
...
def model_crop_size(input_shape=(112, 112, 1, 3), nb_classes=40,weight_decay = 0.005):
    inputs = Input(input_shape)
    # 64x64x16
    x = Conv3D(32, (3, 3, 3), strides=(1, 1, 1), activation='relu',padding='same',
